...
from model.accountNumber.userStory2 import convert_line_account_numbers_to_int_account_numbers


def run():
    input_file = "resource/input/rawData2.txt"
    output_file = "resource/output/output2.txt"
