...
from model.accountNumber.userStory4 import convert_line_account_numbers_to_int_account_numbers


def run():
    input_file = "resource/input/rawData4.txt"
    output_file = "resource/output/output4.txt"
